...
describe NotesController do
  ...
  let(:valid_attributes) { { "person_id" => "MyString" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved note as @note" do
        ...
        post :create, {:note => { "person_id" => "invalid value" }}, valid_session
        assigns(:note).should be_a_new(Note)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested note" do
        ...
        Note.any_instance.should_receive(:update_attributes).with({ "person_id" => "MyString" })
        put :update, {:id => note.to_param, :note => { "person_id" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the note as @note" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Note.any_instance.stub(:save).and_return(false)
        put :update, {:id => note.to_param, :note => { "person_id" => "invalid value" }}, valid_session
        assigns(:note).should eq(note)
      end
